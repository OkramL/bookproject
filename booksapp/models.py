...
def max_value_current_year(year):
    """ Return current year as number (year) """
...
class Book(models.Model):
    ...
    isbn = models.CharField(verbose_name='ISBN number', max_length=13,
                            validators=[validate_digits_length])
    ...
    def __str__(self):
        ...
        return (f'{self.title}, {self.author}, {self.book_language}, '
                f'{self.isbn}, {self.number_of_pages}, {self.book_published_year}, '
